 ...
 * the Store: state is preserved and [PulseStore.onSetup] is not repeated. The Store scope is
 * cancelled only when the owner is cleared, which is when the screen is gone for good.
 *
...
internal class PulseStoreHolder(
    ...
    private val retention: PulseStoreRetention = store.retain()
